...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "ARCTIXMC Championship Season 1 — 3 Days. 6 Rounds. 1 Champion. Register now for the premier Minecraft tournament." },
      { property: "og:title", content: "ARCTIXMC Championship — Season 1" },
      { property: "og:description", content: "3 Days. 6 Rounds. 1 Champion." },
